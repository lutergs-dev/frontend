...
<body>
	<Seo title="Intro" titleTemplate="%t% | LuterGS" />

	<div bind:clientWidth={width} bind:clientHeight={height}>
		{#if width > 580}
			<UnstyledButton override={largeMainButtonCss}>
				<Text
					override={largeMainLogoCss}
					align="center"
					variant="gradient"
					weight="bold"
				...
				<div class="largeCircle1">
					<UnstyledButton
						override={largeSubButtonCss}
						on:click={() => {
							movePage('about');
						}}
					>
						<Text
							override={{ fontSize: '1.2rem' }}
							align="center"
							variant="gradient"
							weight="bold"
							gradient={{ from: 'dark', to: 'cyan', deg: 45 }}
...
<style global>
	...
	@keyframes largeRotate2 {
		...
		100% {
			transform: rotate(162deg) translate(-15rem) rotate(-162deg);
		}
	}
	...
	@keyframes largeRotate3 {
		...
		100% {
			transform: rotate(234deg) translate(-15rem) rotate(-234deg);
		}
	}
	...
	@keyframes largeRotate4 {
		...
		100% {
			transform: rotate(306deg) translate(-15rem) rotate(-306deg);
		}
	}
	...
	@keyframes largeRotate5 {
		...
		100% {
			transform: rotate(378deg) translate(-15rem) rotate(-378deg);
		}
	}
	...
	@keyframes smallRotate2 {
		...
		100% {
			transform: rotate(162deg) translate(-9rem) rotate(-162deg);
		}
	}
	...
	@keyframes smallRotate3 {
		...
		100% {
			transform: rotate(234deg) translate(-9rem) rotate(-234deg);
		}
	}
	...
	@keyframes smallRotate4 {
		...
		100% {
			transform: rotate(306deg) translate(-9rem) rotate(-306deg);
		}
	}
	...
	@keyframes smallRotate5 {
		...
		100% {
			transform: rotate(378deg) translate(-9rem) rotate(-378deg);
		}
	}
</style>
